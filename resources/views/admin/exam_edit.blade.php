...
<div x-data="examEditor()" class="w-full max-w-full font-montserrat">
    ...
    <div class="flex flex-row justify-between items-center gap-2">
        <span class="text-[#0D2B70] text-2xl font-montserrat whitespace-nowrap">Title of the Job Here, Contract of Service </span>
        <button class="border border-[#002C76] hover:bg-blue-900 text-[#002C76] hover:text-white font-bold py-2 px-6 rounded inline-flex items-center gap-2">
    ...
    <form method="POST" @submit.prevent="submitForm" action="{{ route('admin.exam.update', $vacancy_id) }}">
        ...
        <div class="mt-10 flex flex-row justify-between items-center gap-4" x-show="questions.length > 0">
            ...
            <button type="button" 
                class="border-2 border-[#002C76] hover:bg-[#002C76] hover:scale-105 
            ...
            <div class="flex gap-3">
                ...
                <button type="submit" 
                    class="use-loader bg-[#002C76]  text-white 

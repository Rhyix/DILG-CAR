...
>>>>>>> parent of 37cccb8 (Vacancies Management table, Applications list table)
                ...
                <div class="flex flex-row items-center ml-4">
                    ...
                    <select id="jobTypeFilter" class="h-10 cursor-pointer px-4 rounded-md border border-[#0D2B70] text-[#0D2B70] font-semibold bg-white
                                focus:outline-none focus:ring-2 focus:ring-[#0D2B70] focus:ring-offset-1">
                ...
                <div class="flex flex-row items-center ml-4">
                    ...
                    <select id="examStatusFilter" class="h-10 cursor-pointer px-4 rounded-md border border-[#0D2B70] text-[#0D2B70] font-semibold bg-white
                                focus:outline-none focus:ring-2 focus:ring-[#0D2B70] focus:ring-offset-1">
                        <option value="">All</option>
            ...
            <div class="flex-none bg-[#0D2B70] text-white">
                <table class="w-full text-left border-collapse table-fixed">
                    <thead class="bg-[#0D2B70] text-white sticky top-0 z-10">
                        <tr>
                            <th class="py-4 px-6 text-center font-bold uppercase text-sm tracking-wider w-[15%]">Vacancy ID
                            </th>
                            <th class="py-4 px-6 text-center font-bold uppercase text-sm tracking-wider w-[35%]">Job Title
                            </th>
                            <th class="py-4 px-6 text-center font-bold uppercase text-sm tracking-wider w-[20%]">Job Type
                            </th>

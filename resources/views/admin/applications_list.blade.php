...
=======
=======
>>>>>>> parent of 35c4b59 (applicant status updates and exam management full system logic)
<!-- SCROLLABLE BODY CONTAINER -->
    <div class="flex-1 overflow-y-auto min-h-0">
        <table class="w-full align-items-center text-left border-collapse table-fixed">
            <tbody id="vacancy-list" class="divide-y divide-[#0D2B70]">
                                ...
                                <td class="py-4 px-6 text-center w-[25%]">
                                    <div class="flex justify-center items-center">
                                        <button
                                            ...
                                            @if($vacancy->pending_count > 0)
                                                <span
                                                    class="absolute -top-2 -right-2 flex h-5 w-5 items-center justify-center rounded-full bg-red-600 text-[10px] font-bold text-white shadow-sm ring-1 ring-white">
                                                    {{ $vacancy->pending_count }}
                                                </span>
                                            @endif
                                        </button>

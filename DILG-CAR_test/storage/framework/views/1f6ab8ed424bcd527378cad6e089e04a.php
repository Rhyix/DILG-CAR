...
<main class="space-y-6">
    ...
    <section class="border border-blue-700 rounded-2xl max-w-full flex divide-x divide-blue-700 bg-white select-none"
        ...
        <a href="<?php echo e($stat['url']); ?>" class="flex-1 block use-loader">
            <div class="flex flex-col items-center p-4 space-y-1 hover:bg-blue-50">
                <div class="flex justify-center items-center rounded-full bg-blue-300 w-10 h-10">
                    <i class="fa-solid fa-<?php echo e($stat['icon']); ?> text-blue-700 text-lg"></i>
                </div>
                <span class="font-extrabold text-xl font-montserrat"><?php echo e($stat['count']); ?></span>
                <span class="text-sm font-semibold text-gray-400 font-montserrat"><?php echo e($stat['label']); ?></span>
            </div>
        </a>
    ...
    <section class="flex flex-row gap-6 max-w-full">
        ...
        <div class="flex-1 bg-blue-900 rounded-2xl p-6 text-white shadow-lg flex flex-col">
            ...
            <div class="text-lg font-light space-y-1 mb-6 max-w-md font-montserrat">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $openVacancies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacancy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
        ...
        <div class="flex-1 bg-blue-900 rounded-2xl p-6 text-white shadow-lg flex flex-col">
            ...
            <div class="flex flex-col text-white text-sm mr-4">
                ...
                <ul class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $upcomingExams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <li class="grid grid-cols-[minmax(300px,_auto)_160px_80px] items-center">
                            <div class="flex items-center">
                                <i class="fa-solid fa-paperclip"></i>
                                <strong class="ml-2 font-montserrat">
                                    <?php echo e($exam->vacancy->position_title ?? 'Unknown Position'); ?>
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 font-montserrat">
                                    <?php echo e(\Carbon\Carbon::parse($exam->date)->format('F j, Y')); ?>
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 font-montserrat">
                                    <?php echo e(\Carbon\Carbon::parse($exam->time)->format('H:i')); ?>
        ...
        <div class="bg-white border border-blue-700 rounded-2xl p-6 shadow-lg flex flex-col justify-between h-full">
            <div class="space-y-4">
                ...
                <div class="flex justify-end mt-4">
                    <form method="GET" action="<?php echo e(route('dashboard_admin')); ?>" class="mb-4">
        ...
        <div class="bg-white border border-blue-700 rounded-2xl p-6 shadow-md flex flex-col justify-between h-full">
            <div>
                ...
                <div class="text-blue-900 space-y-2 text-sm font-montserrat overflow-y-auto max-h-[260px] pr-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $reviewedApplications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $applicant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <div class="flex items-center gap-2">
                            <i class="fa-solid fa-user text-blue-600"></i>
                            <span><?php echo e(optional($applicant->personalInformation)->first_name ?? 'N/A'); ?> <?php echo e(optional($applicant->personalInformation)->surname ?? ''); ?></span>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            ...
            <div class="pt-6 flex justify-end">
                <a href="<?php echo e(route('applications_list')); ?>" class="use-loader bg-red-700 hover:bg-red-800 transition font-semibold text-white rounded-lg py-3 px-6 flex items-center space-x-2 shadow-md shadow-red-900/50">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        myChart = new Chart(ctx, {
            ...
            data: {
                labels: chartLabels,
                datasets: [{
                    label: 'Applicants in <?php echo e($selectedYear); ?>',
                    data: chartData,
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PDS-main\resources\views/admin/dashboard_admin.blade.php ENDPATH**/ ?>
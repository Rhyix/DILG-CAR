...
>
    ...
    >
        ...
        <div class="flex flex-col sm:flex-row justify-center sm:justify-end gap-3">
            ...
            <form method="POST" action="<?php echo e(route('logout')); ?>" class="w-full sm:w-auto">
                <?php echo csrf_field(); ?>
                <button 
                    type="submit" 
...
<?php /**PATH C:\xampp\htdocs\PDS-main\resources\views/partials/logout-modal.blade.php ENDPATH**/ ?>
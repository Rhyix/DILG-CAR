...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form id="learning-form" class="space-y-8" action="/pds/submit_c3/display_c4" method="POST">
            ...
            <section class="bg-white rounded-2xl shadow-xl p-4 sm:p-8 animate-slide-in">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
                    <div class="flex items-start sm:items-center">
                        <span class="material-icons text-blue-600 mr-3 text-2xl sm:text-3xl mt-1 sm:mt-0">volunteer_activism</span>
                        <h2 class="text-lg sm:text-2xl font-bold text-gray-900 leading-tight">VI. VOLUNTARY WORK OR INVOLVEMENT IN CIVIC/<br class="hidden sm:block">NON-GOVERNMENT/PEOPLE/VOLUNTARY ORGANIZATION/S</h2>
                    </div>
                    <button type="button" id="add-voluntary-btn" class="w-full sm:w-auto flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm sm:text-base">
                ...
                <div id="voluntary-empty" class="text-center py-8 sm:py-12 bg-gray-50 rounded-lg">
                    ...
                    <button type="button" class="add-voluntary-trigger px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm sm:text-base">
            ...
            <section class="bg-white rounded-2xl shadow-xl p-4 sm:p-8 animate-slide-in">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
                    <div class="flex items-start sm:items-center">
                        ...
                        <h2 class="text-lg sm:text-2xl font-bold text-gray-900 leading-tight">VII. LEARNING AND DEVELOPMENT (L&D) INTERVENTIONS/<br class="hidden sm:block">TRAINING PROGRAMS ATTENDED</h2>
                    </div>
                    <button type="button" id="add-learning-btn" class="w-full sm:w-auto flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm sm:text-base">
                        <span class="material-icons mr-2 text-sm sm:text-base">add_circle</span>
                        Add Training
                    </button>
                </div>
                ...
                <div id="learning-empty" class="text-center py-8 sm:py-12 bg-gray-50 rounded-lg">
                    ...
                    <button type="button" class="add-learning-trigger px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm sm:text-base">
                        <span class="material-icons mr-2 text-sm sm:text-base">add</span>
                ...
                <div class="space-y-6 sm:space-y-8">
                    ...
                    <div>
                        ...
                        <div id="skills-container" class="space-y-3">
                            <div class="flex flex-col sm:flex-row gap-3">
                                <input type="text" name="skills[]" placeholder="Enter special skill or hobby" class="flex-1 px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm sm:text-base">
                                <button type="button" class="add-skill px-4 py-2 sm:py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors duration-200 flex items-center justify-center">
                    ...
                    <div>
                        ...
                        <div id="distinctions-container" class="space-y-3">
                            <div class="flex flex-col sm:flex-row gap-3">
                                <input type="text" name="distinctions[]" placeholder="Enter non-academic distinction or recognition (Write in full)" class="flex-1 px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm sm:text-base">
                                <button type="button" class="add-distinction px-4 py-2 sm:py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors duration-200 flex items-center justify-center">
                                    <span class="material-icons text-sm sm:text-base">add</span>
                                </button>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div id="organizations-container" class="space-y-3">
                            <div class="flex flex-col sm:flex-row gap-3">
                                <input type="text" name="organizations[]" placeholder="Enter organization name (Write in full)" class="flex-1 px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm sm:text-base">
                                <button type="button" class="add-organization px-4 py-2 sm:py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors duration-200 flex items-center justify-center">
                                    <span class="material-icons text-sm sm:text-base">add</span>
                                </button>
                            </div>
                        </div>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center mt-8 gap-4">
                <button type="button" onclick="window.location.href='<?php echo e(route('display_c2')); ?>'" class="use-loader w-full sm:w-auto px-6 py-3 bg-gray-200 text-gray-700 rounded-lg font-semibold hover:bg-gray-300 transition-colors duration-200 flex items-center justify-center">
                    <span class="material-icons mr-2">arrow_back</span>
                    Previous
                </button>
                <button type="submit" class="w-full sm:w-auto px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors duration-200 flex items-center justify-center">
                    Next
...
<?php echo $__env->make('layout.pds_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DILG-CAR_pp\resources\views/pds/c3.blade.php ENDPATH**/ ?>
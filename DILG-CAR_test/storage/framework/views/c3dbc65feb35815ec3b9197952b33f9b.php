<?php $__env->startSection('title', 'DILG - Admin Account Management'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <main class="w-full space-y-6">
        ...
        <section class="flex justify-between items-center">
           ...
           <?php echo $__env->make('partials.admin_add_account', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </section>
 ...
 <section class="space-y-4">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
        <div class="grid grid-cols-[1.2fr_2fr_1fr_1.5fr_1fr] gap-4 border-2 border-[#0D2B70] rounded-xl py-5 px-6">
            <div class="font-extrabold"><?php echo e($admin->username); ?></div>
            <div class="font-extrabold overflow-hidden text-ellipsis whitespace-nowrap">
                <?php echo e($admin->email); ?>

            </div>
            <div class="text-center font-semibold"><?php echo e(ucfirst($admin->role)); ?></div>
            ...
            <div class="flex justify-center items-center gap-3">
                <form method="POST" action="<?php echo e(route($admin->is_active ? 'admin.deactivate' : 'admin.activate', $admin->id)); ?>">
    <?php echo csrf_field(); ?>
    <button type="submit"
        class="w-[130px] 
               <?php echo e($admin->is_active ? 'bg-[#C5292F] hover:bg-red-700' : 'bg-[#00127.0.0.1] hover:bg-green-700'); ?> 
        ...
        <?php echo e($admin->is_active ? 'DEACTIVATE' : 'ACTIVATE'); ?>
                ...
                <?php echo $__env->make('partials.admin_edit_account', ['admin' => $admin], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
    ...
    >
        ...
        <ul class="mt-1 list-disc list-inside text-sm">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array(session('error'))): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = session('error'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PDS-main\resources\views/admin/admin_account_management.blade.php ENDPATH**/ ?>
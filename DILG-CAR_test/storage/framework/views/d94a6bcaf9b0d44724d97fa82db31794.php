...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form id="myForm" method="POST" action='/pds/submit_c2/display_c3'>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center mt-8 gap-4">
                <button type="button" onclick="window.location.href='<?php echo e(route('display_c1')); ?>'" class="use-loader w-full sm:w-auto px-6 py-3 bg-gray-200 text-gray-700 rounded-lg font-semibold hover:bg-gray-300 transition-colors duration-200 flex items-center justify-center">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var all_user_work_exps = <?php echo e(Js::from($all_user_work_exps)); ?>
            ...
            var all_user_civil_service_eligibility = <?php echo e(Js::from($all_user_civil_service_eligibility)); ?>
...
<?php echo $__env->make('layout.pds_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PDS-main\resources\views/pds/c2.blade.php ENDPATH**/ ?>
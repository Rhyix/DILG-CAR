...
<main class="w-full space-y-6">
    ...
    <section class="space-y-4">
        ...
        <div class="grid grid-cols-[1.2fr_2fr_1.5fr_auto_auto_1fr] gap-4 border-2 border-[#0D2B70] rounded-xl py-5 px-6 items-center text-[#0D2B70] select-none overflow-x-hidden">
            <div class="font-extrabold"><?php echo e($vacancy->vacancy_id); ?></div>
                <div>
            ...
            <div class="text-center font-semibold"><?php echo e($vacancy->vacancy_id); ?>-EXAM</div>

            <!-- Copy Link -->
            <div class="text-center w-fit mx-auto">
                <button onclick="window.location.href='exam/<?php echo e($vacancy->vacancy_id); ?>'"
            ...
            <!-- Edit -->
            <div class="text-center w-fit mx-auto">
                <button onclick="window.location.href='<?php echo e(route('admin.exam.edit', $vacancy->vacancy_id)); ?>'" class="use-loader bg-[#00127.0.0.1] hover:opacity-80 transition text-white font-semibold rounded-full flex items-center gap-2 px-4 py-2 text-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <!-- Status -->
            <div class="text-center w-fit mx-auto">
                <button onclick="window.location.href='<?php echo e(route('admin.manage_exam', $vacancy->vacancy_id)); ?>'" class="use-loader bg-[#002C76] hover:opacity-80 transition text-white font-semibold rounded-full flex items-center gap-2 px-4 py-2 text-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PDS-main\resources\views/admin/exam_management.blade.php ENDPATH**/ ?>
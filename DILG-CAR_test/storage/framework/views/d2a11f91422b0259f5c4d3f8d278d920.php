...
<?php $__env->startSection('content'); ?>
    ...
    <div class="flex flex-1 flex-col sm:flex-row items-start gap-1 sm:gap-3">
        <?php echo $__env->make('partials.data_privacy_notice', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('partials.privacy_policy', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('partials.about_this_site', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PDS-main\resources\views/dashboard_user/about.blade.php ENDPATH**/ ?>
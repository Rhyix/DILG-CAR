...
<aside id="sidebar"
    ...
    <div>
        ...
        <nav class="mt-8 space-y-1 px-2 font-montserrat">
            ...
            class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition
                    <?php echo e(request()->routeIs('vacancies_management')
                        ? 'bg-[#002C76] text-white'
                        : 'text-[#002C76] hover:text-white hover:bg-[#002C76]'); ?>">
            ...
            class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition
                    <?php echo e(request()->routeIs('admin_applications_list')
                        ? 'bg-[#002C76] text-white'
                        : 'text-[#002C76] hover:text-white hover:bg-[#002C76]'); ?>">
            ...
            class="use-loader group flex items-center rounded-md px-4 py-2 text-sm font-bold transition
                    <?php echo e(request()->routeIs('admin_exam_management')
                        ? 'bg-[#002C76] text-white'
                        : 'text-[#002C76] hover:text-white hover:bg-[#002C76]'); ?>">
...
<?php /**PATH C:\xampp\htdocs\PDS-main\resources\views/partials/sidebar_admin.blade.php ENDPATH**/ ?>
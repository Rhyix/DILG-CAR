<?php $__env->startSection('title', 'Other Information'); ?>
                ...
                <div class="question-card">
                    ...
                    <div class="flex gap-4 mb-4"> <!-- NUMBER 34: a -->
                            <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                                ...
                                value="yes" <?php echo e(old('related_34_a', $data['related_34_a'] ?? '') == 'yes' ? 'checked' : ''); ?>>
                                <span>Yes</span>
                            </label>
                            <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                                <input required type="radio" name="related_34_a"  class="mr-2"
                                value="no" <?php echo e(old('related_34_a', $data['related_34_a'] ?? '') == 'no' ? 'checked' : ''); ?>>
                                <span>No</span>
                            </label>
                    </div>
                    ...
                    <div class="flex gap-6"> <!-- NUMBER 34: b -->
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            ...
                            value="yes" <?php echo e(old('related_34_b', $data['related_34_b'] ?? '') != null ? 'checked' : ''); ?>>
                            <span>Yes</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            <input required type="radio" name="related_34_b" class="mr-2"
                            value="no" <?php echo e(old('related_34_b', $data['related_34_b'] ?? '') == 'no' ? 'checked' : ''); ?>>
                            <span>No</span>
                        </label>
                    </div>
                    <div id="related-details" class="detail-input">
                        ...
                        ><?php echo e(old('related_34_b', $data['related_34_b'] ?? '')); ?></textarea>
                    </div>
                </div> <!-- END: NUMBER 34 -->
                ...
                <div class="question-card">
                    ...
                    <div class="flex gap-6"> <!-- NUMBER 35: a -->
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            ...
                            value="yes" <?php echo e(old('guilty_35_a', $data['guilty_35_a'] ?? '') != null ? 'checked' : ''); ?>>
                            <span>Yes</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            <input type="radio" name="guilty_35_a" class="mr-2"
                            value="no" <?php echo e(old('guilty_35_a', $data['guilty_35_a'] ?? '') == 'no' ? 'checked' : ''); ?>>
                            <span>No</span>
                        </label>
                    </div>
                    <div id="admin-details" class="detail-input">
                        ...
                        ><?php echo e(old('guilty_35_a', $data['guilty_35_a'] ?? '')); ?></textarea>
                    </div>
                </div>
                ...
                <div class="question-card mt-6">
                    ...
                    <div class="flex gap-6"> <!-- NUMBER 35: b -->
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            ...
                            value="yes" <?php echo e(old('criminal_35_b', $data['criminal_35_b'] ?? '') != null ? 'checked' : ''); ?>>
                            <span>Yes</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            <input type="radio" name="criminal_35_b" class="mr-2"
                            value="no" <?php echo e(old('criminal_35_b', $data['criminal_35_b'] ?? '') == 'no' ? 'checked' : ''); ?>>
                            <span>No</span>
                        </label>
                    </div>
                   <div id="criminal-details" class="detail-input hidden mt-4">
                        ...
                        <div class="mb-3">
                            ...
                            value="<?php echo e(old('criminal_35_b_array.date', $data['criminal_35_b_array']['date'] ?? '')); ?>" >
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            value="<?php echo e(old('criminal_35_b_array.status', $data['criminal_35_b_array']['status'] ?? '')); ?>" >
                        </div>
                    </div>
                ...
                <div class="question-card mt-6">
                    ...
                    <div class="flex gap-6"> <!-- NUMBER 36 -->
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            ...
                            value="yes" <?php echo e(old('convicted_36', $data['convicted_36'] ?? '') != null ? 'checked' : ''); ?>>
                            <span>Yes</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            <input type="radio" name="convicted_36" class="mr-2"
                            value="no" <?php echo e(old('convicted_36', $data['convicted_36'] ?? '') == 'no' ? 'checked' : ''); ?>>
                            <span>No</span>
                        </label>
                    </div>
                    <div id="convicted-details" class="detail-input">
                        ...
                        ><?php echo e(old('convicted_36', $data['convicted_36'] ?? '')); ?></textarea>
                    </div>
                </div>
            </section>
            ...
            <section class="bg-white rounded-2xl shadow-xl p-8 animate-slide-in">
                <div class="question-card">
                    ...
                    <div class="flex gap-6"> <!--NUMBER 37 -->
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            <input type="radio" name="separated_37" class="mr-2" required
                             value="yes" <?php echo e(old('separated_37', $data['separated_37'] ?? '') != null ? 'checked' : ''); ?>>
                            <span>Yes</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            <input type="radio" name="separated_37" class="mr-2"
                             value="no" <?php echo e(old('separated_37', $data['separated_37'] ?? '') == 'no' ? 'checked' : ''); ?>>
                            <span>No</span>
                        </label>
                    </div>
                    <div id="separated-details" class="detail-input">
                        ...
                        ><?php echo e(old('separated_37', $data['separated_37'] ?? '')); ?></textarea>
                    </div>
                </div>
    </section>
    <section class="bg-white rounded-2xl shadow-xl p-8 animate-slide-in">
                <div class="question-card mt-6">
                    ...
                    <div class="flex gap-6"> <!-- NUMBER 38: a -->
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            <input type="radio" name="candidate_38_a" class="mr-2" required
                             value="yes" <?php echo e(old('candidate_38', $data['candidate_38'] ?? '') != null ? 'checked' : ''); ?>>
                            <span>Yes</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            <input type="radio" name="candidate_38_a" class="mr-2"
                             value="no" <?php echo e(old('candidate_38', $data['candidate_38'] ?? '') == 'no' ? 'checked' : ''); ?>>
                            <span>No</span>
                        </label>
                    </div>
                    <div id="candidate-details" class="detail-input">
                        ...
                        ><?php echo e(old('candidate_38', $data['candidate_38'] ?? '')); ?></textarea>
                    </div>
                </div>
                ...
                <div class="question-card mt-6">
                    ...
                    <div class="flex gap-6"> <!-- NUMBER 38: b -->
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            <input type="radio" name="resigned_38_b" class="mr-2" required
                             value="yes" <?php echo e(old('resigned_38_b', $data['resigned_38_b'] ?? '') != null ? 'checked' : ''); ?>>
                            <span>Yes</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            <input type="radio" name="resigned_38_b" class="mr-2"
                             value="no" <?php echo e(old('resigned_38_b', $data['resigned_38_b'] ?? '') == 'no' ? 'checked' : ''); ?>>
                            <span>No</span>
                        </label>
                    </div>
                    <div id="resign-details" class="detail-input">
                        ...
                        ><?php echo e(old('resigned_38_b', $data['resigned_38_b'] ?? '')); ?></textarea>
                    </div>
                </div>
    </section>
    ...
    <section class="bg-white rounded-2xl shadow-xl p-8 animate-slide-in">
                <div class="question-card mt-6">
                    ...
                    <div class="flex gap-6"> <!-- NUMBER 39 -->
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            <input type="radio" name="immigrant_39"class="mr-2" required
                             value="yes" <?php echo e(old('immigrant_39', $data['immigrant_39'] ?? '') != null ? 'checked' : ''); ?>>
                            <span>Yes</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                            <input type="radio" name="immigrant_39" class="mr-2"
                             value="no" <?php echo e(old('immigrant_39', $data['immigrant_39'] ?? '') == 'no' ? 'checked' : ''); ?>>
                            <span>No</span>
                        </label>
                    </div>
                    <div id="immigrant-details" class="detail-input">
                        ...
                        ><?php echo e(old('immigrant_39', $data['immigrant_39'] ?? '')); ?></textarea>
                    </div>
                </div>
    ...
    <section class="bg-white rounded-2xl shadow-xl p-8 animate-slide-in">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 pb-6 border-b-2 border-gray-200">
                    <div class="question-card">
                        ...
                        <div class="flex gap-4"> <!-- NUMBER 40: a -->
                            <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                                <input type="radio" name="indigenous_40_a" class="mr-2" required
                                 value="yes" <?php echo e(old('indigenous_40_a', $data['indigenous_40_a'] ?? '') != null ? 'checked' : ''); ?>>
                                <span>Yes</span>
                            </label>
                            <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                                <input type="radio" name="indigenous_40_a" class="mr-2"
                                 value="no" <?php echo e(old('indigenous_40_a', $data['indigenous_40_a'] ?? '') == 'no' ? 'checked' : ''); ?>>
                                <span>No</span>
                            </label>
                        </div>
                        <div id="indigenous-details" class="relative">
                                ...
                                value="<?php echo e(old('indigenous_40_a', $data['indigenous_40_a'] ?? '')); ?>" >
                    ...
                    <div class="question-card">
                        ...
                        <div class="flex gap-4"> <!-- NUMBER 40: b -->
                            <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                                <input type="radio" name="pwd_40_b" class="mr-2" required
                                 value="yes" <?php echo e(old('pwd_40_b', $data['pwd_40_b'] ?? '') != null ? 'checked' : ''); ?>>
                                <span>Yes</span>
                            </label>
                            <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                                <input type="radio" name="pwd_40_b" class="mr-2"
                                 value="no" <?php echo e(old('pwd_40_b', $data['pwd_40_b'] ?? '') == 'no' ? 'checked' : ''); ?>>
                                <span>No</span>
                            </label>
                        </div>
                        <div id="pwd-details" class="relative">
                                ...
                                value="<?php echo e(old('pwd_40_b', $data['pwd_40_b'] ?? '')); ?>" >
                    ...
                    <div class="question-card">
                        ...
                        <div class="flex gap-4"> <!-- NUMBER 40: c -->
                            <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                                <input type="radio" name="solo_parent_40_c" class="mr-2" required
                                 value="yes" <?php echo e(old('solo_parent_40_c', $data['solo_parent_40_c'] ?? '') != null ? 'checked' : ''); ?>>
                                <span>Yes</span>
                            </label>
                            <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors">
                                <input type="radio" name="solo_parent_40_c" class="mr-2"
                                 value="no" <?php echo e(old('solo_parent_40_c', $data['solo_parent_40_c'] ?? '') == 'no' ? 'checked' : ''); ?>>
                                <span>No</span>
                            </label>
                        </div>
                        <div id="solo-parent-details" class="relative">
                                ...
                                value="<?php echo e(old('solo_parent_40_c', $data['solo_parent_40_c'] ?? '')); ?>" >
                                <label class="floating-label absolute mt-3 left-4 top-3 text-gray-500 pointer-events-none">Specify ID No.</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="relative">
                                <input required type="text" name="ref1_name" required value="<?php echo e(old('ref1_name', $data['ref1_name'] ?? '')); ?>"
                            ...
                            <div class="relative">
                                <input required type="tel" name="ref1_tel" required value="<?php echo e(old('ref1_tel', $data['ref1_tel'] ?? '')); ?>"
                                placeholder=" " class="floating-label-input w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer">
                                <label class="floating-label absolute left-4 top-3 text-gray-500 pointer-events-none">Telephone No.*</label>
                            </div>
                            <div class="relative md:col-span-2">
                                <input required type="text" name="ref1_address" required value="<?php echo e(old('ref1_address', $data['ref1_address'] ?? '')); ?>"
                                placeholder=" " class="floating-label-input w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="relative">
                                <input required type="text" name="ref2_name" required value="<?php echo e(old('ref2_name', $data['ref2_name'] ?? '')); ?>"
                                placeholder=" " class="floating-label-input w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer">
                                <label class="floating-label absolute left-4 top-3 text-gray-500 pointer-events-none">Name*</label>
                            </div>
                            <div class="relative">
                                <input required type="tel" name="ref2_tel" required value="<?php echo e(old('ref2_tel', $data['ref2_tel'] ?? '')); ?>"
                                placeholder=" " class="floating-label-input w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer">
                                <label class="floating-label absolute left-4 top-3 text-gray-500 pointer-events-none">Telephone No*.</label>
                            </div>
                            <div class="relative md:col-span-2">
                                <input required type="text" name="ref2_address" required value="<?php echo e(old('ref2_address', $data['ref2_address'] ?? '')); ?>"
                                placeholder=" " class="floating-label-input w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer">
                                <label class="floating-label absolute left-4 top-3 text-gray-500 pointer-events-none">Address*</label>
                            </div>
                        </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="relative">
                                <input required type="text" name="ref3_name" required value="<?php echo e(old('ref3_name', $data['ref3_name'] ?? '')); ?>"
                                placeholder=" " class="floating-label-input w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer">
                                <label class="floating-label absolute left-4 top-3 text-gray-500 pointer-events-none ">Name*</label>
                            </div>
                            <div class="relative">
                                <input required type="tel" name="ref3_tel" required value="<?php echo e(old('ref3_tel', $data['ref3_tel'] ?? '')); ?>"
                                placeholder=" " class="floating-label-input w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer">
                                <label class="floating-label absolute left-4 top-3 text-gray-500 pointer-events-none">Telephone No.*</label>
                            </div>
                            <div class="relative md:col-span-2">
                                <input required type="text" name="ref3_address" required value="<?php echo e(old('ref3_address', $data['ref3_address'] ?? '')); ?>"
                                placeholder=" " class="floating-label-input w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer">
                                <label class="floating-label absolute left-4 top-3 text-gray-500 pointer-events-none">Address*</label>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="relative">
                        <select id="govt_id_type" name="govt_id_type" class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all appearance-none bg-white" required>
                            ...
                            <?php $selectedId = old('govt_id_type', $data['govt_id_type'] ?? '') ?>
                            <option value="Passport" <?php echo e($selectedId == 'passport' ? 'selected' : ''); ?>>Passport</option>
                            <option value="GSIS" <?php echo e($selectedId == 'gsis' ? 'selected' : ''); ?>>GSIS</option>
                            <option value="SSS" <?php echo e($selectedId == 'sss' ? 'selected' : ''); ?>>SSS</option>
                            <option value="PhilHealth" <?php echo e($selectedId == 'philhealth' ? 'selected' : ''); ?>>PhilHealth</option>
                            <option value="Driver's License" <?php echo e($selectedId == 'drivers' ? 'selected' : ''); ?>>Driver's License</option>
                            <option value="PRC" <?php echo e($selectedId == 'prc' ? 'selected' : ''); ?>>PRC</option>
                            <option value="Voter's ID" <?php echo e($selectedId == 'voters' ? 'selected' : ''); ?>>Voter's ID</option>
                            <option value="PhilSys/National ID" <?php echo e($selectedId == 'voters' ? 'selected' : ''); ?>>PhilSys/National ID</option>
                            <option value="other" <?php echo e(!in_array($selectedId, ['Passport','GSIS','SSS','PhilHeath','Driver\'s License','PRC','Voter\'s ID','PhilSys/National ID']) && $selectedId !== '' ? 'selected' : ''); ?>>Other</option>
                        </select>
                        <label class="absolute -top-2 left-3 bg-white px-1 text-sm text-gray-600">ID Type</label>
                    </div>

                    <!-- If Other, Show Input Field -->
                    <div id="other-id-wrapper" class="relative <?php echo e(!in_array($selectedId, ['passport','gsis','sss','philhealth','drivers','prc','voters']) && $selectedId !== '' ? '' : 'hidden'); ?>">
                        <input type="text" id="other_id_input" name="govt_id_other" class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all"
                            ...
                            value="<?php echo e(old('govt_id_other', $data['govt_id_other'] ?? '')); ?>">
                    </div>

                    <!-- ID Number -->
                    <div class="relative">
                        <input type="text" name="govt_id_number" required value="<?php echo e(old('govt_id_number', $data['govt_id_number'] ?? '')); ?>"
                    ...
                    <!-- Date Issued -->
                    <div class="relative">
                        <input type="date" name="govt_id_date_issued" required value="<?php echo e(old('govt_id_date_issued', $data['govt_id_date_issued'] ?? '')); ?>"
                    ...
                    <!-- Place Issued -->
                    <div class="relative">
                        <input type="text" name="govt_id_place_issued" required value="<?php echo e(old('govt_id_place_issued', $data['govt_id_place_issued'] ?? '')); ?>"
                        class="floating-label-input w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer" placeholder=" ">
            ...
            <section class="bg-white rounded-2xl shadow-xl p-8 animate-slide-in">
                ...
                <div class="photo-upload-area" id="photo-upload-area">
                    ...
                    <img
                        id="photo-preview"
                        src="<?php echo e($data['photo_preview_url'] ?? ''); ?>"
                        alt="Uploaded Photo"
                        class="mt-2 h-48 w-48 object-cover border rounded-md shadow"
                        style="<?php echo e(empty($data['photo_preview_url']) ? 'display:none;' : ''); ?>">
                </div>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center mt-8 gap-4">
                <button type="button" onclick="window.location.href='<?php echo e(route('display_c3')); ?>'" class="use-loader w-full sm:w-auto px-6 py-3 bg-gray-200 text-gray-700 rounded-lg font-semibold hover:bg-gray-300 transition-colors duration-200 flex items-center justify-center">
...
<?php echo $__env->make('layout.pds_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PDS-main\resources\views/pds/c4.blade.php ENDPATH**/ ?>
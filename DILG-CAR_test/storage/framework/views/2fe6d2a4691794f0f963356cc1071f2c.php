...
<style>
  ...
  <body class="bg-white h-screen flex flex-col">
    ...
    <main class="flex-grow flex justify-center items-center">
        <form method="POST" action="<?php echo e(route('forgot.password.send.otp')); ?>">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\PDS-main\resources\views/login_register/forgot_password.blade.php ENDPATH**/ ?>
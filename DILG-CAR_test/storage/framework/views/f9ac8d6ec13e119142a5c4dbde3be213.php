<?php $__env->startSection('title', 'PDS - Personal Data Sheet'); ?>
<?php $__env->startSection('content'); ?>
    <!-- Main Content -->
    <main class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-4 sm:py-8 mb-20 sm:mb-0" style="padding-top: 0px;">
        <form id="myForm" class="space-y-4 sm:space-y-8" action="/pds/submit_c1/display_c2" method="POST" x-data="{ civilStatus: '<?php echo e(old('civil_status', session('form.c1.civil_status'))); ?>' }">
            <?php echo csrf_field(); ?>
            ...
            <section class="bg-white rounded-lg sm:rounded-2xl shadow-xl p-4 sm:p-8 animate-slide-in">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
                    <div class="relative w-full sm:w-[400px]">
                        <input
                            ...
                            name="cs_id_no"
                            disabled
                            value="<?php echo e(old('cs_id_no', session('form.c1.cs_id_no'))); ?>"
                            placeholder=" "
                ...
                <div class="mobile-stack md:grid md:grid-cols-4 gap-4 sm:gap-6 mb-4 sm:mb-6">
                    ...
                    <div class="relative">
                        <input type="text" id="first_name" name="first_name" value="<?php echo e(old('first_name', session('form.c1.first_name'))); ?>" placeholder=" " required class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        <input type="text" id="middle_name" name="middle_name" value="<?php echo e(old('middle_name', session('form.c1.middle_name'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        <input type="text" id="name_extension" name="name_extension" value="<?php echo e(old('name_extension', session('form.c1.name_extension'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                ...
                <div class="mobile-stack md:grid md:grid-cols-4 gap-4 sm:gap-6 mb-4 sm:mb-6">
                    <div class="relative">
                        <input type="text" id="date_of_birth" name="date_of_birth" value="<?php echo e(old('date_of_birth', session('form.c1.date_of_birth'))); ?>" required class="w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm sm:text-base">
                        <label for="date_of_birth" class="absolute -top-2 left-3 bg-white px-1 text-sm text-gray-600">3. Date of Birth *</label>
                    </div>
                    <div class="relative md:col-span-2">
                        <input type="text" id="place_of_birth" name="place_of_birth" value="<?php echo e(old('place_of_birth', session('form.c1.place_of_birth'))); ?>" placeholder=" " required class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-4 sm:space-x-6">
                            <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors text-sm sm:text-base">
                                <input type="radio" name="sex" value="male" <?php echo e(old('sex', session('form.c1.sex')) == 'male' ? 'checked' : ''); ?> class="mr-2 text-blue-600 focus:ring-blue-500" required>
                                <span>Male</span>
                            </label>
                            <label class="flex items-center cursor-pointer hover:text-blue-600 transition-colors text-sm sm:text-base">
                                <input type="radio" name="sex" value="female" <?php echo e(old('sex', session('form.c1.sex')) == 'female' ? 'checked' : ''); ?> class="mr-2 text-blue-600 focus:ring-blue-500">
                                <span>Female</span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="mobile-stack md:grid md:grid-cols-4 gap-4 sm:gap-6 mb-4 sm:mb-6">
                    <div class="relative">
                        <select id="civil_status" name="civil_status" x-model="civilStatus" required class="w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all appearance-none bg-white text-sm sm:text-base">
                            <option value="" disabled <?php echo e(old('civil_status', session('form.c1.civil_status')) == '' ? 'selected' : ''); ?>>Select Civil Status</option>
                            <option value="single" <?php echo e(old('civil_status', session('form.c1.civil_status')) == 'single' ? 'selected' : ''); ?>>Single</option>
                            <option value="married"<?php echo e(old('civil_status', session('form.c1.civil_status')) == 'married' ? 'selected' : ''); ?>>Married</option>
                            <option value="widowed"<?php echo e(old('civil_status', session('form.c1.civil_status')) == 'widowed' ? 'selected' : ''); ?>>Widowed</option>
                            <option value="separated"<?php echo e(old('civil_status', session('form.c1.civil_status')) == 'separated' ? 'selected' : ''); ?>>Separated</option>
                            <option value="other"<?php echo e(old('civil_status', session('form.c1.civil_status')) == 'other' ? 'selected' : ''); ?>>Other/s</option>
                        </select>
                        <label class="absolute -top-2 left-3 bg-white px-1 text-sm text-gray-600">6. Civil Status *</label>
                    </div>
                    <!-- Physical Info -->
                    <div class="relative">
                        <input type="number" style="-moz-appearance: textfield; -webkit-appearance: textfield;" required step="0.01" id="height" name="height" value="<?php echo e(old('height', session('form.c1.height'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        <input type="number" style="-moz-appearance: textfield; -webkit-appearance: textfield;" required step="0.1" id="weight" name="weight" value="<?php echo e(old('weight', session('form.c1.weight'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        ...
                        <select id="blood_type" name="blood_type" class="w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all appearance-none bg-white text-sm sm:text-base" required>
                            <option value="" disabled <?php echo e($blood == '' ? 'selected' : ''); ?>>Select Blood Type</option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $validBlood; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($bt); ?>" <?php echo e($blood === $bt ? 'selected' : ''); ?>><?php echo e($bt); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blood && !in_array($blood, $validBlood)): ?>
                                <option value="<?php echo e($blood); ?>" selected><?php echo e($blood); ?></option>
                ...
                <div class="mobile-stack md:grid md:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
                    <div class="relative">
                        <input type="number" style="-moz-appearance: textfield; -webkit-appearance: textfield;" id="gsis_id_no" name="gsis_id_no" value="<?php echo e(old('gsis_id_no', session('form.c1.gsis_id_no'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        <input type="number" style="-moz-appearance: textfield; -webkit-appearance: textfield;" id="pagibig_id_no" name="pagibig_id_no" value="<?php echo e(old('pagibig_id_no', session('form.c1.pagibig_id_no'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        <input type="number" style="-moz-appearance: textfield; -webkit-appearance: textfield;" id="sss_id_no" name="sss_id_no" value="<?php echo e(old('sss_id_no', session('form.c1.sss_id_no'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        <input type="number" style="-moz-appearance: textfield; -webkit-appearance: textfield;" id="tin_no" name="tin_no" value="<?php echo e(old('tin_no', session('form.c1.tin_no'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        <input type="number" style="-moz-appearance: textfield; -webkit-appearance: textfield;" id="agency_employee_no" name="agency_employee_no" value="<?php echo e(old('agency_employee_no', session('form.c1.agency_employee_no'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                ...
                <div class="mobile-stack md:grid md:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                    <div x-data="{ citizenship: '<?php echo e(old('citizenship', session('form.c1.citizenship'))); ?>', dualType: '<?php echo e(old('dual_type', session('form.c1.dual_type'))); ?>' }" class="space-y-4">
                        ...
                        <div class="flex flex-col sm:flex-row gap-2">
                            <label class="inline-flex items-center text-sm sm:text-base">
                                <input type="radio" name="citizenship" value="Filipino" x-model="citizenship"
                                       ...
                                       <?php echo e(old('citizenship', session('form.c1.citizenship')) == 'Filipino' ? 'checked' : ''); ?>>
                            ...
                            <label class="inline-flex items-center text-sm sm:text-base">
                                <input type="radio" name="citizenship" value="Dual Citizenship" x-model="citizenship"
                                       ...
                                       <?php echo e(old('citizenship', session('form.c1.citizenship')) == 'Dual Citizenship' ? 'checked' : ''); ?>>
                        ...
                        <div x-show="citizenship === 'Dual Citizenship'" class="space-y-4 mt-4">
                            ...
                            <div class="flex flex-col sm:flex-row gap-2">
                                <label class="inline-flex items-center text-sm sm:text-base">
                                    <input type="radio" name="dual_type" value="By Birth" x-model="dualType"
                                           class="text-blue-600 border-gray-300 focus:ring-blue-500"
                                           <?php echo e(old('dual_type', session('form.c1.dual_type')) == 'By Birth' ? 'checked' : ''); ?>>
                                    <span class="ml-2 text-gray-700">By Birth</span>
                                </label>
                                <label class="inline-flex items-center text-sm sm:text-base">
                                    <input type="radio" name="dual_type" value="By Naturalization" x-model="dualType"
                                           class="text-blue-600 border-gray-300 focus:ring-blue-500"
                                           <?php echo e(old('dual_type', session('form.c1.dual_type')) == 'By Naturalization' ? 'checked' : ''); ?>>
                            ...
                            <div>
                                ...
                                <input type="text" id="dual_country" name="dual_country"
                                       value="<?php echo e(old('dual_country', session('form.c1.dual_country'))); ?>"
            ...
            <section class="bg-white rounded-lg sm:rounded-2xl shadow-xl p-4 sm:p-8 animate-slide-in">
                ...
                <div class="mobile-stack md:grid md:grid-cols-3 gap-4 sm:gap-6">
                    <div class="relative">
                        <input type="text" id="res_house_no" name="res_house_no" value="<?php echo e(old('res_house_no', session('form.c1.res_house_no'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        <input type="text" id="res_street" name="res_street" value="<?php echo e(old('res_street', session('form.c1.res_street'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        <input type="text" id="res_sub_vil" name="res_sub_vil" value="<?php echo e(old('res_sub_vil', session('form.c1.res_sub_vil'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        <input pattern="\d{4}" maxlength="4" type="text" inputmode="numeric" required id="res_zipcode" name="res_zipcode" value="<?php echo e(old('res_zipcode', session('form.c1.res_zipcode'))); ?>" placeholder="" class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
            ...
            <section class="bg-white rounded-lg sm:rounded-2xl shadow-xl p-4 sm:p-8 animate-slide-in mt-2">
                ...
                <div class="mobile-stack md:grid md:grid-cols-3 gap-4 sm:gap-6">
                    <div class="relative">
                        <input type="text" id="per_house_no" name="per_house_no" value="<?php echo e(old('per_house_no', session('form.c1.per_house_no'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        <input type="text" id="per_street" name="per_street" value="<?php echo e(old('per_street', session('form.c1.per_street'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        <input type="text" id="per_sub_vil" name="per_sub_vil" value="<?php echo e(old('per_sub_vil', session('form.c1.per_sub_vil'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        <input pattern="\d{4}" maxlength="4" type="text" inputmode="numeric" required id="per_zipcode" name="per_zipcode" value="<?php echo e(old('per_zipcode', session('form.c1.per_zipcode'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
            ...
            <section class="bg-white rounded-lg sm:rounded-2xl shadow-xl p-4 sm:p-8 animate-slide-in mt-2">
                ...
                <div class="mobile-stack md:grid md:grid-cols-3 gap-4 sm:gap-6">
                    <div class="relative">
                        <input type="tel" style="-moz-appearance: textfield; -webkit-appearance: textfield;" pattern="^0\d{9,10}$" maxlength="11" id="telephone_no" name="telephone_no" value="<?php echo e(old('telephone_no', session('form.c1.telephone_no'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="relative">
                        <input required type="email" id="email_address" name="email_address" value="<?php echo e(old('email_address', session('form.c1.email_address'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
            ...
            <section class="bg-white rounded-lg sm:rounded-2xl shadow-xl p-4 sm:p-8 animate-slide-in">
                ...
                <div class="mb-6 sm:mb-8" x-show="civilStatus !== 'single'" x-cloak>
                    ...
                    <div class="mobile-stack md:grid md:grid-cols-4 gap-4 sm:gap-6 mb-4">
                        <div class="relative">
                            <input type="text" id="spouse_surname" name="spouse_surname" value="<?php echo e(old('spouse_surname', session('form.c1.spouse_surname'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                        ...
                        <div class="relative">
                            <input type="text" id="spouse_first_name" name="spouse_first_name" value="<?php echo e(old('spouse_first_name', session('form.c1.spouse_first_name'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                        ...
                        <div class="relative">
                            <input type="text" id="spouse_middle_name" name="spouse_middle_name" value="<?php echo e(old('spouse_middle_name', session('form.c1.spouse_middle_name'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                        ...
                        <div class="relative">
                            <input type="text" id="spouse_name_extension" name="spouse_name_extension" value="<?php echo e(old('spouse_name_extension', session('form.c1.spouse_name_extension'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="mobile-stack md:grid md:grid-cols-4 gap-4 sm:gap-6">
                        <div class="relative">
                            <input type="text" id="spouse_occupation" name="spouse_occupation" value="<?php echo e(old('spouse_occupation', session('form.c1.spouse_occupation'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                        ...
                        <div class="relative">
                            <input type="text" id="spouse_employer" name="spouse_employer" value="<?php echo e(old('spouse_employer', session('form.c1.spouse_employer'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
...
[$__name, $__params] = $__split('pds-children-form', [
                        'children' => (array) old('children', session('form.c1.children', []))
                    ]);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1058618012-0', null);
...
?>
                ...
                <div class="mb-6 sm:mb-8">
                    ...
                    <div class="mobile-stack md:grid md:grid-cols-4 gap-4 sm:gap-6 mb-4">
                        <div class="relative">
                            <input type="text" id="father_surname" name="father_surname" value="<?php echo e(old('father_surname', session('form.c1.father_surname'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                        ...
                        <div class="relative">
                            <input type="text" id="father_first_name" name="father_first_name" value="<?php echo e(old('father_first_name', session('form.c1.father_first_name'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                        ...
                        <div class="relative">
                            <input type="text" id="father_middle_name" name="father_middle_name" value="<?php echo e(old('father_middle_name', session('form.c1.father_middle_name'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                        ...
                        <div class="relative">
                            <input type="text" id="father_name_extension" name="father_name_extension" value="<?php echo e(old('father_name_extension', session('form.c1.father_name_extension'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                    ...
                    <div class="mobile-stack md:grid md:grid-cols-3 gap-4 sm:gap-6">
                        <div class="relative">
                            <input required type="text" id="mother_maiden_surname" name="mother_maiden_surname" value="<?php echo e(old('mother_maiden_surname', session('form.c1.mother_maiden_surname'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                        ...
                        <div class="relative">
                            <input required type="text" id="mother_maiden_first_name" name="mother_maiden_first_name" value="<?php echo e(old('mother_maiden_first_name', session('form.c1.mother_maiden_first_name'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                        ...
                        <div class="relative">
                            <input type="text" id="mother_maiden_middle_name" name="mother_maiden_middle_name" value="<?php echo e(old('mother_maiden_middle_name', session('form.c1.mother_maiden_middle_name'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
            ...
            <section class="bg-white rounded-lg sm:rounded-2xl shadow-xl p-4 sm:p-8 animate-slide-in">
                ...
                <div class="mb-6">
                    ...
                    <div class="mobile-stack md:grid md:grid-cols-4 gap-4 sm:gap-6">
                        <div class="relative">
                            <input required type="text" id="elem_from" name="elem_from" value="<?php echo e(old('elem_from', session('form.c1.elem_from'))); ?>" class="edu-date w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm sm:text-base">
                            <label class="absolute -top-2 left-3 bg-white px-1 text-sm text-gray-600">From*</label>
                        </div>
                        <div class="relative">
                            <input required type="text" id="elem_to" name="elem_to" value="<?php echo e(old('elem_to', session('form.c1.elem_to'))); ?>" class="edu-date w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm sm:text-base">
                        ...
                        <div class="relative md:col-span-4">
                            <input required type="text" id="elem_school" name="elem_school" value="<?php echo e(old('elem_school', session('form.c1.elem_school'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                        ...
                        <div class="relative md:col-span-2">
                            <input pattern="\d{4}" maxlength="4" type="text" inputmode="numeric" required id="elem_year_graduated" name="elem_year_graduated" value="<?php echo e(old('elem_year_graduated', session('form.c1.elem_year_graduated'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                        ...
                        <div class="relative md:col-span-2">
                            <input type="text" id="elem_academic_honors" name="elem_academic_honors" value="<?php echo e(old('elem_academic_honors', session('form.c1.elem_academic_honors'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                ...
                <div class="mb-6">
                    ...
                    <div class="mobile-stack md:grid md:grid-cols-4 gap-4 sm:gap-6">
                        <div class="relative">
                            <input required type="text" id="jhs_from" name="jhs_from" value="<?php echo e(old('jhs_from', session('form.c1.jhs_from'))); ?>" class="edu-date w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm sm:text-base">
                            <label for="jhs_from" class="absolute -top-2 left-3 bg-white px-1 text-sm text-gray-600">From*</label>
                        </div>
                        <div class="relative">
                            <input required type="text" id="jhs_to" name="jhs_to" value="<?php echo e(old('jhs_to', session('form.c1.jhs_to'))); ?>" class="edu-date w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm sm:text-base">
                        ...
                        <div class="relative md:col-span-4">
                            <input required type="text" id="jhs_school" name="jhs_school" value="<?php echo e(old('jhs_school', session('form.c1.jhs_school'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                        ...
                        <div class="relative md:col-span-2">
                            <input required pattern="\d{4}" maxlength="4" type="text" inputmode="numeric" id="jhs_year_graduated" name="jhs_year_graduated" value="<?php echo e(old('jhs_year_graduated', session('form.c1.jhs_year_graduated'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                        ...
                        <div class="relative md:col-span-2">
                            <input type="text" id="jhs_academic_honors" name="jhs_academic_honors" value="<?php echo e(old('jhs_academic_honors', session('form.c1.jhs_academic_honors'))); ?>" placeholder=" " class="floating-label-input w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all peer text-sm sm:text-base">
                ...
                <div class="mb-6">
                    <?php echo $__env->make('partials.pds-education-form', [
    ...
    'education_data' => $grad_schools
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center mt-6 sm:mt-8 gap-4">
                <button type="button" onclick="window.location.href='<?php echo e(route('dashboard_user')); ?>'" class="use-loader w-full sm:w-auto px-4 sm:px-6 py-3 bg-gray-200 text-gray-700 rounded-lg font-semibold hover:bg-gray-300 transition-colors duration-200 flex items-center justify-center text-sm sm:text-base">
...
<script>
    ...
    const perProvinceName = savedState.per_province ?? "<?php echo e(old('per_province', session('form.c1.per_province'))); ?>";
    const perCityName = savedState.per_city ?? "<?php echo e(old('per_city', session('form.c1.per_city'))); ?>";
    const perBrgyName = savedState.per_brgy ?? "<?php echo e(old('per_brgy', session('form.c1.per_brgy'))); ?>";
    const resProvinceName = savedState.res_province ?? "<?php echo e(old('res_province', session('form.c1.res_province'))); ?>";
    const resCityName = savedState.res_city ?? "<?php echo e(old('res_city', session('form.c1.res_city'))); ?>";
    const resBrgyName = savedState.res_brgy ?? "<?php echo e(old('res_brgy', session('form.c1.res_brgy'))); ?>";
    ...
    setRadio('sex', savedState.sex ?? "<?php echo e(old('sex', session('form.c1.sex'))); ?>");
    hookRadio('sex');
    const civil = document.getElementById('civil_status');
    if (civil){
        const preset = savedState.civil_status ?? "<?php echo e(old('civil_status', session('form.c1.civil_status'))); ?>";
    ...
    setRadio('citizenship', savedState.citizenship ?? "<?php echo e(old('citizenship', session('form.c1.citizenship'))); ?>");
    hookRadio('citizenship');
    setRadio('dual_type', savedState.dual_type ?? "<?php echo e(old('dual_type', session('form.c1.dual_type'))); ?>");
    hookRadio('dual_type');
            ...
            <div class="pds-preview">
                ...
                <table class="grid">
                    ...
                    <tr>
                        ...
                        <td class="value"><span id="preview_surname"><?php echo e(old('surname', session('form.c1.surname'))); ?></span></td>
                        <td class="label small">NAME EXTENSION (JR., SR.)</td>
                        <td class="value"><span id="preview_name_extension"><?php echo e(old('name_extension', session('form.c1.name_extension'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">2. FIRST NAME</td>
                        <td class="value"><span id="preview_first_name"><?php echo e(old('first_name', session('form.c1.first_name'))); ?></span></td>
                        <td class="label">MIDDLE NAME</td>
                        <td class="value"><span id="preview_middle_name"><?php echo e(old('middle_name', session('form.c1.middle_name'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">3. DATE OF BIRTH (dd/mm/yyyy)</td>
                        <td class="value"><span id="preview_date_of_birth"><?php echo e(old('date_of_birth', session('form.c1.date_of_birth'))); ?></span></td>
                        ...
                        <td class="value" rowspan="2">
                            ...
                            <div style="display:flex; gap:8px; align-items:center; margin-top:4px;">
                                ...
                                <span class="underline" id="preview_dual_country"><?php echo e(old('dual_country', session('form.c1.dual_country'))); ?></span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="label">4. PLACE OF BIRTH</td>
                        <td class="value"><span id="preview_place_of_birth"><?php echo e(old('place_of_birth', session('form.c1.place_of_birth'))); ?></span></td>
                    </tr>
                    <tr>
                        ...
                        <td class="value small">
                            <div class="muted">House/Block/Lot No. <span class="underline" id="preview_res_house"><?php echo e(old('res_house_no', session('form.c1.res_house_no'))); ?></span> &nbsp;&nbsp; Street <span class="underline" id="preview_res_street"><?php echo e(old('res_street', session('form.c1.res_street'))); ?></span></div>
                            <div class="muted" style="margin-top:4px;">Subdivision/Village <span class="underline" id="preview_res_sub"><?php echo e(old('res_sub_vil', session('form.c1.res_sub_vil'))); ?></span> &nbsp;&nbsp; Barangay <span class="underline" id="preview_res_brgy"><?php echo e(old('res_brgy', session('form.c1.res_brgy'))); ?></span></div>
                            <div class="muted" style="margin-top:4px;">City/Municipality <span class="underline" id="preview_res_city"><?php echo e(old('res_city', session('form.c1.res_city'))); ?></span> &nbsp;&nbsp; Province <span class="underline" id="preview_res_province"><?php echo e(old('res_province', session('form.c1.res_province'))); ?></span></div>
                            <div class="muted" style="margin-top:4px;">ZIP CODE <span class="underline" id="preview_res_zip"><?php echo e(old('res_zipcode', session('form.c1.res_zipcode'))); ?></span></div>
                        </td>
                    </tr>
                    <tr>
                        <td class="label">6. CIVIL STATUS</td>
                        <td class="value"><span id="preview_civil_status"><?php echo e(old('civil_status', session('form.c1.civil_status'))); ?></span></td>
                        <td class="label">18. PERMANENT ADDRESS</td>
                        <td class="value small">
                            <div class="muted">House/Block/Lot No. <span class="underline" id="preview_per_house"><?php echo e(old('per_house_no', session('form.c1.per_house_no'))); ?></span> &nbsp;&nbsp; Street <span class="underline" id="preview_per_street"><?php echo e(old('per_street', session('form.c1.per_street'))); ?></span></div>
                            <div class="muted" style="margin-top:4px;">Subdivision/Village <span class="underline" id="preview_per_sub"><?php echo e(old('per_sub_vil', session('form.c1.per_sub_vil'))); ?></span> &nbsp;&nbsp; Barangay <span class="underline" id="preview_per_brgy"><?php echo e(old('per_brgy', session('form.c1.per_brgy'))); ?></span></div>
                            <div class="muted" style="margin-top:4px;">City/Municipality <span class="underline" id="preview_per_city"><?php echo e(old('per_city', session('form.c1.per_city'))); ?></span> &nbsp;&nbsp; Province <span class="underline" id="preview_per_province"><?php echo e(old('per_province', session('form.c1.per_province'))); ?></span></div>
                            <div class="muted" style="margin-top:4px;">ZIP CODE <span class="underline" id="preview_per_zip"><?php echo e(old('per_zipcode', session('form.c1.per_zipcode'))); ?></span></div>
                        </td>
                    </tr>
                    <tr>
                        <td class="label">7. HEIGHT (m)</td>
                        <td class="value"><span id="preview_height"><?php echo e(old('height', session('form.c1.height'))); ?></span></td>
                        <td class="label">19. TELEPHONE NO.</td>
                        <td class="value"><span id="preview_telephone"><?php echo e(old('telephone_no', session('form.c1.telephone_no'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">8. WEIGHT (kg)</td>
                        <td class="value"><span id="preview_weight"><?php echo e(old('weight', session('form.c1.weight'))); ?></span></td>
                        <td class="label">20. MOBILE NO.</td>
                        <td class="value"><span id="preview_mobile"><?php echo e(old('mobile_no', session('form.c1.mobile_no'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">9. BLOOD TYPE</td>
                        <td class="value"><span id="preview_blood_type"><?php echo e(old('blood_type', session('form.c1.blood_type'))); ?></span></td>
                        <td class="label">21. E-MAIL ADDRESS (if any)</td>
                        <td class="value"><span id="preview_email"><?php echo e(old('email_address', session('form.c1.email_address'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">10. GSIS ID NO.</td>
                        <td class="value"><span id="preview_gsis"><?php echo e(old('gsis_id_no', session('form.c1.gsis_id_no'))); ?></span></td>
                        <td class="label">14. TIN NO.</td>
                        <td class="value"><span id="preview_tin"><?php echo e(old('tin_no', session('form.c1.tin_no'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">11. PAG-IBIG ID NO.</td>
                        <td class="value"><span id="preview_pagibig"><?php echo e(old('pagibig_id_no', session('form.c1.pagibig_id_no'))); ?></span></td>
                        <td class="label">15. AGENCY EMPLOYEE NO.</td>
                        <td class="value"><span id="preview_agency"><?php echo e(old('agency_employee_no', session('form.c1.agency_employee_no'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">12. PHILHEALTH NO.</td>
                        <td class="value"><span id="preview_philhealth"><?php echo e(old('philhealth_no', session('form.c1.philhealth_no'))); ?></span></td>
                        <td class="label">13. SSS ID NO.</td>
                        <td class="value"><span id="preview_sss"><?php echo e(old('sss_id_no', session('form.c1.sss_id_no'))); ?></span></td>
                    </tr>
                    <tr><th colspan="4" class="section-title">II. FAMILY BACKGROUND</th></tr>
                    <tr>
                        <td class="label">22. SPOUSE’S SURNAME</td>
                        <td class="value"><span id="preview_spouse_surname"><?php echo e(old('spouse_surname', session('form.c1.spouse_surname'))); ?></span></td>
                        <td class="label">NAME EXTENSION (JR., SR.)</td>
                        <td class="value"><span id="preview_spouse_name_extension"><?php echo e(old('spouse_name_extension', session('form.c1.spouse_name_extension'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">FIRST NAME</td>
                        <td class="value"><span id="preview_spouse_first_name"><?php echo e(old('spouse_first_name', session('form.c1.spouse_first_name'))); ?></span></td>
                        <td class="label">MIDDLE NAME</td>
                        <td class="value"><span id="preview_spouse_middle_name"><?php echo e(old('spouse_middle_name', session('form.c1.spouse_middle_name'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">OCCUPATION</td>
                        <td class="value"><span id="preview_spouse_occupation"><?php echo e(old('spouse_occupation', session('form.c1.spouse_occupation'))); ?></span></td>
                        <td class="label">EMPLOYER/BUSINESS NAME</td>
                        <td class="value"><span id="preview_spouse_employer"><?php echo e(old('spouse_employer', session('form.c1.spouse_employer'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">BUSINESS ADDRESS</td>
                        <td class="value"><span id="preview_spouse_business_address"><?php echo e(old('spouse_business_address', session('form.c1.spouse_business_address'))); ?></span></td>
                        <td class="label">TELEPHONE NO.</td>
                        <td class="value"><span id="preview_spouse_telephone"><?php echo e(old('spouse_telephone', session('form.c1.spouse_telephone'))); ?></span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="value"><span id="preview_father_surname"><?php echo e(old('father_surname', session('form.c1.father_surname'))); ?></span></td>
                        <td class="label">NAME EXTENSION (JR., SR.)</td>
                        <td class="value"><span id="preview_father_name_extension"><?php echo e(old('father_name_extension', session('form.c1.father_name_extension'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">FIRST NAME</td>
                        <td class="value"><span id="preview_father_first_name"><?php echo e(old('father_first_name', session('form.c1.father_first_name'))); ?></span></td>
                        <td class="label">MIDDLE NAME</td>
                        <td class="value"><span id="preview_father_middle_name"><?php echo e(old('father_middle_name', session('form.c1.father_middle_name'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">25. MOTHER’S MAIDEN NAME</td>
                        <td class="value"><span id="preview_mother_maiden_surname"><?php echo e(old('mother_maiden_surname', session('form.c1.mother_maiden_surname'))); ?></span></td>
                        <td class="label"></td>
                        <td class="value"></td>
                    </tr>
                    <tr>
                        <td class="label">FIRST NAME</td>
                        <td class="value"><span id="preview_mother_maiden_first_name"><?php echo e(old('mother_maiden_first_name', session('form.c1.mother_maiden_first_name'))); ?></span></td>
                        <td class="label">MIDDLE NAME</td>
                        <td class="value"><span id="preview_mother_maiden_middle_name"><?php echo e(old('mother_maiden_middle_name', session('form.c1.mother_maiden_middle_name'))); ?></span></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="value"><span id="preview_elem_school"><?php echo e(old('elem_school', session('form.c1.elem_school'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">Basic Education/Degree/Course</td>
                        <td class="value"><span id="preview_elem_basic"><?php echo e(old('elem_basic', session('form.c1.elem_basic'))); ?></span></td>
                        <td class="label">Period of Attendance From/To</td>
                        <td class="value"><span id="preview_elem_period"><?php echo e(old('elem_from', session('form.c1.elem_from'))); ?> – <?php echo e(old('elem_to', session('form.c1.elem_to'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">Highest Level/Units Earned</td>
                        <td class="value"></td>
                        <td class="label">Year Graduated</td>
                        <td class="value"><span id="preview_elem_year"><?php echo e(old('elem_year_graduated', session('form.c1.elem_year_graduated'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">Scholarship/Academic Honors Received</td>
                        <td class="value" colspan="3"><span id="preview_elem_honors"><?php echo e(old('elem_academic_honors', session('form.c1.elem_academic_honors'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">Level</td>
                        <td class="value">Secondary</td>
                        <td class="label">Name of School</td>
                        <td class="value"><span id="preview_jhs_school"><?php echo e(old('jhs_school', session('form.c1.jhs_school'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">Basic Education/Degree/Course</td>
                        <td class="value"><span id="preview_jhs_basic"><?php echo e(old('jhs_basic', session('form.c1.jhs_basic'))); ?></span></td>
                        <td class="label">Period of Attendance From/To</td>
                        <td class="value"><span id="preview_jhs_period"><?php echo e(old('jhs_from', session('form.c1.jhs_from'))); ?> – <?php echo e(old('jhs_to', session('form.c1.jhs_to'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">Highest Level/Units Earned</td>
                        <td class="value"></td>
                        <td class="label">Year Graduated</td>
                        <td class="value"><span id="preview_jhs_year"><?php echo e(old('jhs_year_graduated', session('form.c1.jhs_year_graduated'))); ?></span></td>
                    </tr>
                    <tr>
                        <td class="label">Scholarship/Academic Honors Received</td>
                        <td class="value" colspan="3"><span id="preview_jhs_honors"><?php echo e(old('jhs_academic_honors', session('form.c1.jhs_academic_honors'))); ?></span></td>
                    </tr>
                    <tr>
...
<?php echo $__env->make('layout.pds_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PDS-main\resources\views/pds/pds.blade.php ENDPATH**/ ?>
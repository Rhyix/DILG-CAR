<div class="mb-6">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div wire:key="child-<?php echo e($index); ?>" class="border-2 border-gray-200 rounded-lg p-4 mb-4">
            <!-- Header with Remove Button -->
            <div class="flex justify-between items-center mb-4">
                <span class="text-sm font-medium text-gray-600">Child <?php echo e($index + 1); ?></span>
                <button
                    type="button"
                    wire:click.prevent="removeChild(<?php echo e($index); ?>)"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input
                        name="children[<?php echo e($index); ?>][name]"
                        type="text"
                        wire:model.lazy="children.<?php echo e($index); ?>.name"
                ...
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        wire:model.lazy="children.<?php echo e($index); ?>.dob"
...
<?php /**PATH C:\xampp\htdocs\PDS-main\resources\views/livewire/pds-children-form.blade.php ENDPATH**/ ?>
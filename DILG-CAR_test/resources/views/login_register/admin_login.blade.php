...
<body 
  ...
  <div x-show="!isMobile" class="min-h-screen flex">
    ...
    <div class="flex-1 flex items-center justify-center bg-white min-h-screen shadow-lg rounded-r-3xl">
      <form class="w-[468px] h-[538px] p-8 rounded-xl border border-blue-700 shadow-xl" action="{{ route('admin.login') }}" method="POST" autocomplete="off">
        @csrf
...
if (window.innerWidth < 768) {
    window.location.href = "{{ route('mobile.locked') }}";
  }
    </script>
</html>